...
if (role_ID == 6) {
      ...
      out.write("\r\n                            </div>\r\n                        </nav>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <!-- Header End -->\r\n\r\n\r\n            <!-- Blog list Start -->\r\n            <div class=\"container d-flex justify-content-center mt-3 mb-3\">\r\n                <h1 class=\"section-title text-center text-primary text-uppercase\" style=\"text-align: center\"> ");
      out.print( blogType);
 ...
 if (blogType.equalsIgnoreCase("News")) {
                                            out.println("selected");
                                        }
      out.write(">News</option>\r\n                                    <option value=\"Review\" ");
 if (blogType.equalsIgnoreCase("Review")) {
                                            out.println("selected");
                                        }
      out.write(">Review</option>\r\n                                    <option value=\"Promotion\" ");
 if (blogType.equalsIgnoreCase("Promotion")) {
                                            out.println("selected");
                                        }
      out.write(">Promotion</option>\r\n                                    <option value=\"Guide\" ");
 if (blogType.equalsIgnoreCase("Guide")) {
                                            out.println("selected");
                                        }
      out.write(">Guide</option>\r\n                                    ");
 if (role_ID == 4) { 
      out.write("\r\n                                    <option value=\"About\" ");
 if (blogType.equalsIgnoreCase("About")) {
                                            out.println("selected");
                                        }
      out.write(">About</option>\r\n                                    ");
}
      out.write("\r\n                                </select>\r\n                            </div>\r\n                            <div style=\"\">\r\n                                <h6>Page: <input class=\"\" style=\"width: 8vw\" type=\"number\" name=\"cPage\" value=\"");
      out.print(cPage);
      out.write("\"/>  / ");
      out.print(maxPage);
      out.write("</h6>\r\n                            </div>\r\n                            <div style=\"display: flex;justify-content: center\">\r\n                                <h6>Blog/Page: </h6>\r\n                                <select name=\"bpPage\">\r\n                                    <option value=\"5\" ");
 ...
 if (bpPage == 20) {
      ...
      out.print( listBlogs.get(key).getTitle());
      ...
      out.print( listBlogs.get(key).getPublication_date());
      out.write("</p>    \r\n                    <div><p class=\"\" style=\"max-width: 40vw\">");
      out.print( listBlogs.get(key).getContent().substring(0, 100) + "...");
      out.write("</p></div>    \r\n                    <div><form action=\"viewBlogDetail\" method=\"POST\">\r\n                            <input style=\"\" hidden=\"\" type=\"number\" name=\"blog_ID\" value=\"");
      out.print(key);
